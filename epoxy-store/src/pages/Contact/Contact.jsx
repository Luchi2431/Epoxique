...
const Contact = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error("Došlo je do greške prilikom slanja emaila. Molimo pokušajte ponovo kasnije.");
        ...
        <div className="contact-page">
            ...
            <div className="contact-content">
                ...
                <form className="contact-form">
                    ...
                    <div className="form-group">
                        <input type="tel" name="phone" value={formData.phone} onChange={handleChange} placeholder="Broj telefona *" required />
                    </div>
                    <div className="form-group">
