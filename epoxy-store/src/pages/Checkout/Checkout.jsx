...
const Checkout = () => {
  ...
  const handleCheckout = async () => {
    if (!termsAccepted) {
      toast.error(
        "Molim vas prihvatite uslove i odredbe pre nego što nastavite!"
      );
      return;
    }
    ...
    try {
      ...
      toast.error(
        error.message || "Došlo je do greške prilikom kreiranja narudžbine"
      );
    }
  };
        ...
        <div className="checkout-container">
            ...
            {cart.map((item) => (
              <div key={item.id} className="cart-item">
                ...
                <div className="item-details">
                  ...
                  <p>
                    <b>Dimenzije:</b> {item.dimensions.length}x
                    {item.dimensions.width}x{item.dimensions.height}cm
                  </p>
                  <p className="price">
                    Cena: ${Number(item.price).toFixed(2)}
                  </p>
                  <button
          ...
          <div className="terms-section">
            <div className="terms-checkbox">
              ...
              />
              <label htmlFor="terms">Prihvatam uslove i odredbe</label>
            </div>
            <button
